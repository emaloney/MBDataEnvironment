...
DOCSET_BUNDLE_ID="${DOCSET_PUBLISHER_ID}.MBDataEnvironment"
...
ONLINE_ROOT_URL="https://rawgit.com/emaloney/MBDataEnvironment/master/Documentation/API/"
...
$APPLEDOC_PATH \
	...
	--clean-output \
	--project-name "MBDataEnvironment" \
